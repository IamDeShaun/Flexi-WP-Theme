...
plugins: {
  src: [
    "../../plugins/flexi-metaboxes/packaged/*"
  ],
  dest: ["lib/plugins"]
},
  other: {
...
export const watch = () => {
  ...
  gulp.watch(paths.images.src, gulp.series(copy, reload));
}
...
export const bundles = gulp.series(build, compress);
